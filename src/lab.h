 ...
 * of this struct because internal calculations depending on the ordering.
 */
struct avail
{
 ...
 */
LAB_EXPORT size_t btok(size_t bytes);
 ...
 */
LAB_EXPORT struct avail *buddy_calc(struct buddy_pool *pool, struct avail *buddy);
 ...
 */
LAB_EXPORT void *buddy_malloc(struct buddy_pool *pool, size_t size);
 ...
 */
LAB_EXPORT void buddy_free(struct buddy_pool *pool, void *ptr);
...
*/
LAB_EXPORT void *buddy_realloc(struct buddy_pool *pool, void *ptr, size_t size);
 ...
 */
LAB_EXPORT void buddy_init(struct buddy_pool *pool, size_t size);
 ...
 */
LAB_EXPORT void buddy_destroy(struct buddy_pool *pool);
